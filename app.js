...
const STORAGE_KEY = "usaco-assessment-v1";
const SAVE_DEBOUNCE_MS = 250;
const TIMER_PERSIST_INTERVAL = 5;

const skillLabels = {
  zh: Object.fromEntries(questions.map((q) => [q.skill, q.i18n.zh.skill])),
  en: Object.fromEntries(questions.map((q) => [q.skill, q.i18n.en.skill]))
};
